...
public class FileUtils {
    ...
    public List<SoccerTeamFileEntity> parseFileInfo(MultipartHttpServletRequest request) throws Exception {
		...
		List<SoccerTeamFileEntity> fileInfoList = new ArrayList<>();
		...
		while (fileTagNames.hasNext()) {
			...
			for (MultipartFile file : files) {
				...
				// 파일 정보를 리스트에 저장
				SoccerTeamFileEntity entity = new SoccerTeamFileEntity();
...
public List<SoccerTeamFileDto> parseFileInfo(int teamIdx, MultipartHttpServletRequest request) throws Exception {
		...
		while (fileTagNames.hasNext()) {
			...
			for (MultipartFile file : files) {
				...
				// 파일 정보를 리스트에 저장
				SoccerTeamFileDto dto = new SoccerTeamFileDto();
				dto.setTeamIdx(teamIdx);
    ...
    public List<SoccerTeamFileDto> parseFileInfo(int teamIdx, MultipartFile[] files) throws Exception {
